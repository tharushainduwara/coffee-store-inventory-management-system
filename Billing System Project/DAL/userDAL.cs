...
namespace Billing_System_Project.DAL
{
    internal class userDAL
    {
        ...
        public bool Update(userBILL u)
        {
            ...
            try
            {
                String sql = "UPDATE tbl_users SET first_name=@first_name,last_name=@last_name,email=@email,username=@username,password=@password," +
                    "contact=@contact,address=@address,gender=@gender,user_type=@user_type,added_date=@added_date,added_by=@added_by WHERE id=@id";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        //Select user on database using keywords
        ...
        public userBILL GetIdFromUsername(string username)
        {
