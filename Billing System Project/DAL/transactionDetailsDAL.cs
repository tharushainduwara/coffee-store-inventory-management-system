...
namespace Billing_System_Project.DAL
{
    internal class transactionDetailsDAL
    {
        ...
        //Insert Method for Transaction Detail
        public bool InsertTransactionDetail(transactionDetailsBILL td)
        {
            ...
            try
            {
                //Query to add new transaction_deatail
                string sql = "INSERT INTO tbl_transaction_detail (product_id,rate,qty,total,dea_cust_id,added_date,added_by) VALUES" +
                    "(@product_id,@rate,@qty,@total,@dea_cust_id,@added_date,@added_by); SELECT @@IDENTITY";
